...
- [10.0.0](https://github.com/invirtu-libraries/Invirtu-React-Native-Widgets/releases/tag/v10.0.0) - Android Gradle plugin is only required when opening the project stand-alone
- [9.0.0](https://github.com/invirtu-libraries/Invirtu-React-Native-Widgets/releases/tag/v9.0.0) - props updates to injectedJavaScript are no longer immutable.
- [8.0.0](https://github.com/invirtu-libraries/Invirtu-React-Native-Widgets/releases/tag/v8.0.0) - onNavigationStateChange now triggers with hash url changes
- [7.0.1](https://github.com/invirtu-libraries/Invirtu-React-Native-Widgets/releases/tag/v7.0.1) - Removed UIWebView
- [6.0.**2**](https://github.com/invirtu-libraries/Invirtu-React-Native-Widgets/releases/tag/v6.0.2) - Update to AndroidX. Make sure to enable it in your project's `android/gradle.properties`. See [Getting Started Guide](docs/Getting-Started.md).
- [5.0.**1**](https://github.com/invirtu-libraries/Invirtu-React-Native-Widgets/releases/tag/v5.0.0) - Refactored the old postMessage implementation for communication from webview to native.
- [4.0.0](https://github.com/invirtu-libraries/Invirtu-React-Native-Widgets/releases/tag/v4.0.0) - Added cache (enabled by default).
- [3.0.0](https://github.com/invirtu-libraries/Invirtu-React-Native-Widgets/releases/tag/v3.0.0) - WKWebview: Add shared process pool so cookies and localStorage are shared across webviews in iOS (enabled by default).
- [2.0.0](https://github.com/invirtu-libraries/Invirtu-React-Native-Widgets/releases/tag/v2.0.0) - First release this is a replica of the core webview component

**Upcoming:**

- this.webView.postMessage() removal (never documented and less flexible than injectJavascript) -> [how to migrate](https://github.com/invirtu-libraries/Invirtu-React-Native-Widgets/issues/809)
- Kotlin rewrite
- Maybe Swift rewrite
...
- If you encounter a build error during the task `:app:mergeDexRelease`, you need to enable multidex support in `android/app/build.gradle` as discussed in [this issue](https://github.com/invirtu-libraries/Invirtu-React-Native-Widgets/issues/1344#issuecomment-650544648)

## Contributing

See [Contributing.md](https://github.com/invirtu-libraries/Invirtu-React-Native-Widgets/blob/master/docs/Contributing.md)
