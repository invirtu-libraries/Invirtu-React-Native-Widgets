...
If you are unsure how something should be implemented from the JS side, look at [WebView.android.tsx](https://github.com/invirtu-libraries/Invirtu-React-Native-Widgets/blob/master/src/WebView.android.tsx) in the React Native WebView source.
